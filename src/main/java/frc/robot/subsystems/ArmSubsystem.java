...
import static frc.robot.Constants.ReefLevel.A_IO_POSITION;
import static frc.robot.Constants.ReefLevel.A_TILT_HIGH_POSITION;
import static frc.robot.Constants.ReefLevel.C_L1_POSITION;
import static frc.robot.Constants.ReefLevel.C_L2_POSITION;
import static frc.robot.Constants.ReefLevel.C_L3_POSITION;
import static frc.robot.Constants.ReefLevel.C_STATION_POSITION;
import static frc.robot.Constants.ReefLevel.E_AL2_POSITION;
import static frc.robot.Constants.ReefLevel.E_AL3_POSITION;
import static frc.robot.Constants.ReefLevel.E_L1_POSITION;
import static frc.robot.Constants.ReefLevel.E_L2_POSITION;
import static frc.robot.Constants.ReefLevel.E_L3_POSITION;
import static frc.robot.Constants.ReefLevel.E_PROCESSOR_POSITION;
import static frc.robot.Constants.ReefLevel.E_STATION_POSITION;
